...
public class IntelligenceService {
    ...
    public IntelligenceService(FlightProvider flightProvider,
    ...
    public Map<String, Object> getTravelPredictions(String destination, String origin) {
        ...
        Map<String, Object> crowdMap = new LinkedHashMap<>();
        crowdMap.put("level", crowds.getOrDefault("crowdStatus", "Moderate"));
        crowdMap.put("score", crowds.getOrDefault("crowdIndex", 50));
        crowdMap.put("advise", "Check Tavily research for real-time crowd advisories.");
        crowdMap.put("temperature", crowds.getOrDefault("temperature", "22°C"));
        crowdMap.put("condition", crowds.getOrDefault("condition", "Partly Sunny"));
        prediction.put("crowds", crowdMap);
