-- =========================================================================
-- TRIP MIND AI - POSTGRESQL MIGRATION SCHEMA SCRIPT
-- =========================================================================

-- Clean existing tables if any
DROP TABLE IF EXISTS preferences CASCADE;
DROP TABLE IF EXISTS weather_caches CASCADE;
...
-- 6. Destination Categories (ElementCollection)
