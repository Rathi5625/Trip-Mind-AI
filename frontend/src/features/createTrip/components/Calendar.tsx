...
import { DATE_EVENT_BADGES } from "../constants/seasonData"
        ...
        {days.map((date, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={cn(
                  "relative z-10 flex size-9.5 items-center justify-center rounded-full text-xs font-bold transition-all",
                  startPin || endPin
              ...
              {activeEvent && current && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-20 pointer-events-none whitespace-nowrap shadow-sm">
                  <span className={cn(
