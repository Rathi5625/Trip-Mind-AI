...
export function DestinationCard({
  ...
  return (
    <Link href={`/discover/${id}`} className="block">
      <motion.div
        whileHover={{ y: -3 }}
        className="w-[280px] rounded-3xl border border-black/5 bg-white shadow-sm dark:border-white/5 dark:bg-slate-900/60 backdrop-blur-xl overflow-hidden shrink-0 select-none text-left flex flex-col group cursor-pointer"
      >
