...
export default function LoginPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col md:flex-row bg-[#F8F9FB] dark:bg-[#0B0F19] transition-colors duration-300 font-sans">
      {/* Theme toggle placed at top-right for quick adjustments */}
      <div className="absolute top-6 right-6 z-20">
        <ThemeToggle />
      </div>

      {/* Left Column: Premium Interactive Hero and Stats (Hidden on Mobile) */}
      ...
      {/* Right Column: Centered Login Panel */}
